...
int main() {
  ...
  cout << endl << "PostOrder  traversal of tree is:-" << endl;
  printPostOrder(root);

  cout << endl << "LevelOrder traversal of tree is:-" << endl;
  printLevelOrder(root);

  // linkNextNodesQue(root);
  linkNextNodesRec(root);
  cout << endl << "LevelOrder traversal of tree using next pointers is:-" << endl;
